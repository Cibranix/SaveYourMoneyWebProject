...
*
*/
class Expenses extends BaseRest {
...
->map("GET",	"/expenses", array($expenseRest,"getExpenses"))
->map("GET",	"/expenses/$1", array($expenseRest,"readExpense"))
->map("POST", "/expenses", array($expenseRest,"createExpense"))
->map("PUT",	"/expenses/$1", array($expenseRest,"updateExpense"))
->map("DELETE", "/expenses/$1", array($expenseRest,"deleteExpense"));
